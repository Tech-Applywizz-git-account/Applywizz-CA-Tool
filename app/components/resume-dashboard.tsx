...
import { TrendingUp, Users, DollarSign, Calendar, ChevronLeft, ChevronRight, User, Eye, EyeOff, FileText, CheckCircle2, LogOut, LayoutDashboard, BrainCircuit, Info } from "lucide-react"
...
export function ResumeDashboard({ user, onLogout, viewerMode }: ResumeDashboardProps) {
    ...
    const [activeTab, setActiveTab] = useState<"resumes" | "forage">("resumes")
                ...
                {loading ? (
                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                        ...
                        <div className="grid grid-cols-1 gap-6">
                            <div className="flex bg-slate-200/50 p-1 w-fit rounded-xl border border-slate-200">
                                <button className={`px-6 py-2 text-sm font-bold rounded-lg transition-all ${activeTab === "resumes" ? "bg-white text-indigo-700 shadow-sm" : "text-slate-500 hover:text-slate-700"}`} onClick={() => setActiveTab("resumes")}>Resume Registry</button>
                                <button className={`px-6 py-2 text-sm font-bold rounded-lg transition-all ${activeTab === "forage" ? "bg-emerald-600 text-white shadow-sm" : "text-slate-500 hover:text-slate-700"}`} onClick={() => setActiveTab("forage")}>Forage Sales</button>
                            </div>
                            ...
                            {activeTab === "resumes" ? (
                                ...
                                <Card className="border border-emerald-100 overflow-hidden rounded-2xl shadow-sm">
                        ...
                        {/* Slab Rule Suggestions Table - Relocated Below Tables */}
                        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden mt-8">
                            <div className="p-4 bg-slate-50 border-b border-slate-100 flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    <BrainCircuit className="h-5 w-5 text-indigo-600" />
                                    <h4 className="text-sm font-black text-slate-800 uppercase tracking-widest">Job Simulation Bonus Slab Matrix</h4>
                                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t border-slate-200">
                            ...
                            <Card className="border-0 shadow-sm bg-indigo-50/50 rounded-2xl p-5 ring-1 ring-indigo-100 flex flex-col">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <h4 className="text-xs font-black text-indigo-900 uppercase tracking-widest">Resume Incentives</h4>
                                </div>
                            ...
                            <Card className="border-0 shadow-sm bg-emerald-50/50 rounded-2xl p-5 ring-1 ring-emerald-100 flex flex-col">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <h4 className="text-xs font-black text-emerald-900 uppercase tracking-widest">Forage Simulation</h4>
                                </div>
                                <div className="space-y-3 flex-grow">
                            ...
                            <Card className="border-0 shadow-sm bg-violet-50/50 rounded-2xl p-5 ring-1 ring-violet-100 flex flex-col">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <h4 className="text-xs font-black text-violet-900 uppercase tracking-widest">Monthly Slab Bonuses</h4>
                                </div>
                                <div className="space-y-3 flex-grow">
