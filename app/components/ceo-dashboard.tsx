    ...
    <div className="min-h-screen bg-slate-50 p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-7 gap-4 mb-6">
          ...
          <Link href="/ceo-dashboard/clients/active" className="block">
          ...
          <Link href="/ceo-dashboard/clients/paused" className="block">
          ...
          <Link href="/ceo-dashboard/clients/inprogress" className="block">
            <Card className="cursor-pointer hover:shadow-md transition bg-orange-50 border-orange-200">
              <CardContent className="p-4 text-center">
                ...
                <div className="text-sm font-medium text-orange-600">Missed Today</div>
              </CardContent>
            </Card>
          </Link>
