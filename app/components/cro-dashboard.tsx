            ...
            <Dialog open={importOpen} onOpenChange={setImportOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription className="sr-only">Paste your Google Sheets URL to import client data into the system.</DialogDescription>
                </DialogHeader>
            ...
            <Dialog open={newClientOpen} onOpenChange={setNewClientOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription className="sr-only">Fill out the form below to register a new client in the portfolio.</DialogDescription>
                </DialogHeader>
