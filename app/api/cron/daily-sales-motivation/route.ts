...
const getNextSlab = (role: string, currentRevenue: number) => {
    ...
    const slabs = [
        ...
        { rev: 2000, inc: 5500, roles: ['BDA', 'SBDA', 'Sales Head'] },
        { rev: 2500, inc: 8500, roles: ['BDA', 'SBDA', 'Sales Head'] },
        { rev: 3500, inc: 10500, roles: ['BDA', 'SBDA', 'Sales Head'] },
        { rev: 5000, inc: 15500, roles: ['BDA', 'SBDA', 'Sales Head'] },
        { rev: 6000, inc: 19000, roles: ['BDA', 'SBDA', 'Sales Head'] },
        { rev: 7000, inc: 23000, roles: ['BDA', 'SBDA', 'Sales Head'] },
        { rev: 8000, inc: 28000, roles: ['BDA', 'SBDA', 'Sales Head'] },
        { rev: 9000, inc: 34000, roles: ['BDA', 'SBDA', 'Sales Head'] },
        { rev: 10000, inc: 40000, roles: ['BDA', 'SBDA', 'Sales Head'] },
    ];
...
export async function GET(req: Request) {
    try {
        ...
        const { data: users, error: userErr } = await supabaseAdmin
            ...
            .in("role", ["BDT-P", "BDT", "BDA", "SBDA", "Sales Head"])
            .eq("isactive", true);
